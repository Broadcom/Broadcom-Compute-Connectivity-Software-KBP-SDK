...
struct op_hb_bank_read {
    ...
    uint64_t data[31];                /**< Hitbit read data */
};
...
struct op_blk_cpy_move {
    __EO_7(uint32_t direction:1,      /**< 0 ==> increasing address order,  1 ==> decreasing address order */
           uint32_t dbc:1,            /**< Block comapre flag */
           uint32_t resv0:2,          /**< PAD */
           uint32_t num_rows_3_0:4,   /**< Number of rows to copy (3:0) */
           uint32_t num_rows_11_4:8,  /**< Number of rows to copy (11:4)*/
           uint32_t src_addr_7_0:8,   /**< Source Address (7:0) */
           uint32_t src_addr_15_8:8); /**< Source Address (15:8) */

    __EO_6(uint32_t src_addr_19_16:4, /**< Source Address (19:16) */
           uint32_t resv1:4,          /**< PAD */
           uint32_t dest_addr_7_0:8,  /**< Destination Address (7:0) */
           uint32_t dest_addr_15_8:8, /**< Destination Address (15:8) */
           uint32_t dest_addr_19_16:4,/**< Destination Address (19:16) */
           uint32_t resv2:4);         /**< PAD */
};
...
struct op_blk_clr_env {
    __EO_7(uint32_t setnotclear:1,   /**< Set or Clear Flag */
           uint32_t dbc:1,           /**< Block comapre flag */
           uint32_t resv0:2,         /**< PAD */
           uint32_t num_rows_3_0:4,  /**< Number of rows (3:0) */
           uint32_t num_rows_11_4:8, /**< Number of rows (11:4) */
           uint32_t addr_7_0:8,      /**< Address (7:0) */
           uint32_t addr_15_8:8);    /**< Address (15:8) */

    __EO_3(uint32_t addr_19_16:4,    /**< Address (19:16) */
           uint32_t resv1:4,         /**< PAD */
           uint32_t resv2:24);       /**< PAD */
};
...
struct op_uda_write {
    ...
    uint8_t dw[32];                    /**< Entry data */
};

/**
 *@brief structure for UDA Copy
 */
struct op_uda_copy {
...
/**
 *@brief structure for HWA LSNNW instruction
 */
...
/**
 *@brief structure for bulk read complex instruction
 */
...
#define OP2_HWA_BLKWRITE_MAX_DATA_LEN_8 240 /* HWA Bulk Write data max bytes */

/**
 *@brief structure for bulk write complex instruction
 */
