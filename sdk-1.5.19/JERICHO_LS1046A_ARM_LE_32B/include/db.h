...
enum kbp_db_properties {
    ...
    KBP_PROP_MAP_DB_TO_LPM,           /**< Property to convert the existing db to lpm type */
    KBP_PROP_AD_WIDTH_CHANGE_IN_PROGRESS, /**< User is changing the AD width . So disable the hash table*/
