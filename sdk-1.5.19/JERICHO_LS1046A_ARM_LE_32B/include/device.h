...
#define KBP_SDK_VERSION "KBP SDK 1.5.19.2"
...
struct kbp_status_errors {
    ...
    /* these are set properly depending on the device type  */
...
enum kbp_device_properties {
    ...
    KBP_DEVICE_PROP_WB_BUFF_SIZE,               /**< Set the warmboot buffer size use for store : [ size * 1K ]*/
    KBP_DEVICE_PROP_ENABLE_PDC_INTERRUPTS,      /**< Enable or disable PDC interrupt bits : use struct kbp_status_errors to program*/
