 ...
 * The Software copy of the counter is cleared by this API.
 *
 * @param db Valid TAP database handle
...
/**
 * Programmable Action version of the _entry_get_value API. The counter value
 * in the Software is cleared based on the clear_counter value (1 to clear and
 * 0 to keep the counter value)
 *
 * @param db Valid TAP database handle
 * @param clear_counter 1 clears the counter in the Software Copy
 * @param entry_num Entry to read (row number)
 * @param counter_offset Counter offset of the entry to read
 * @param value 64b entry value
 *
...
/**
 * Programmable Action version of the _entry_pair_get_value API. The counter value
 * in the Software is cleared based on the clear_counter value (1 to clear and
 * 0 to keep the counter value)
 *
 * @param db Valid TAP database handle
