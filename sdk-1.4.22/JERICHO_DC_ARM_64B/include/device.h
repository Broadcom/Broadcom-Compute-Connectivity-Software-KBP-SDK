...
#define KBP_SDK_VERSION "KBP SDK 1.4.22.2"
...
enum kbp_device_properties {
    ...
    KBP_DEVICE_PROP_FORCE_INVALIDATE_LOC,    /**< Forcible invalidate the parity location belongs to magic db (reserved/used by external resource) [used by only kbp_device_fix_errors]*/
