...
enum kbp_npxxpt_properties {
    KBP_NPX_PROP_DEBUG_FLAG,             /**< Enable/Diasable the debug flag, if enables logs the response */
    ...
    KBP_NPX_PROP_HANG_ON_ERROR,          /**< if set will be in hang state; error returned by exchip command API */
    ...
    KBP_NPX_PROP_FIX_PARITY_ERRORS,      /**< if set will fix the parity errors, and return the last state */
#ifdef NPX_NPS
